...
module.exports = (env, argv) => {
    ...
    return {
        devServer: {
            ...
            hot: true,
            open: true,
            historyApiFallback: true, // false WDS будет «прямолинейно» обрабатывать ссылки для React Router'а. Т.е. он будет по путь->директория искать index.html, а он у нас один и в корне.
        },
